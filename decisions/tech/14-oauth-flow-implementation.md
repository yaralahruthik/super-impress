...
### 1. User Initiates Connection (`linkedin-connect-button.svelte:15`)
...
### 4. Frontend Stores State & Redirects (`linkedin-connect-button.svelte:9-10`)
...
### 7. Frontend Verifies State - First Check (`callback/+page.svelte:49-52`)
...
### 10. Success & Redirect (`callback/+page.svelte:23-25`)
...
- **Code implementation:**
  ...
  - Frontend button: `frontend/src/lib/features/linkedin/linkedin-connect-button.svelte`
  - Frontend callback: `frontend/src/routes/(protected)/linkedin/callback/+page.svelte`
